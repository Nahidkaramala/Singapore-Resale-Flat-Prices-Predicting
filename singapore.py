...
st.set_page_config(page_title= "Singapore Resale flat price predictions Model | By Nahid Banu",
                   page_icon= icon,
                   layout= "wide",
...
st.markdown("<div class='box'><h1 style='text-align: center; color:Brown; font-size:50px;'>Singapore Flat Resale Price Prediction</h1></div>", unsafe_allow_html=True)
...
st.write( f'<h6 style="color:red(0, 153, 153,0.35);">App Created by Nahid Banu K</h6>', unsafe_allow_html=True )  